...
- [GoldBean API](https://goldbean-api.xyz) — The only Chinese AI multi-modal API cluster in the x402 ecosystem. 53 endpoints: 19 Chinese OCR types, 10 image recognition, NLP, ERNIE LLM chat, TTS, ASR, 28+ language translation, web search, image/video generation. $0.003-$0.08 USDC/call on Base. 50 free calls/day. MCP server at [mcpize.com/mcp/goldbean](https://mcpize.com/mcp/goldbean). Bazaar: [/.well-known/x402-bazaar](https://goldbean-api.xyz/.well-known/x402-bazaar). ([GitHub](https://github.com/wuzenghai616-lang/goldbean))
...
- [GoldBean 🫘](https://goldbean-api.xyz) — The only Chinese AI multi-modal API cluster in x402. 53 Baidu AI endpoints: 19 Chinese OCR types, 10 image recognition, ERNIE LLM, NLP, TTS, ASR, 28+ language translation, web search, image/video generation. $0.003-$0.08 USDC/call on Base. 50 free calls/day, no signup. Bazaar: [/.well-known/x402-bazaar](https://goldbean-api.xyz/.well-known/x402-bazaar). ([GitHub](https://github.com/wuzenghai616-lang/goldbean))
